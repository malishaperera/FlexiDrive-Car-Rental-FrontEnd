...
const CarFormModal: React.FC<CarFormModalProps> = ({ car, onSave, onClose }) => {
    ...
    return (
        ...
        //                 <div className="flex gap-4">
        //                     {carData.image1 && <img src={carData.image1} alt="Car Image 1" className="w-20 h-20 object-cover" />}
        //                     {carData.image2 && <img src={carData.image2} alt="Car Image 2" className="w-20 h-20 object-cover" />}
        //                     {carData.image3 && <img src={carData.image3} alt="Car Image 3" className="w-20 h-20 object-cover" />}
        //                 </div>
        //             </div>
        //
